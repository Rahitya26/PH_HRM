...
const StatCard = ({ title, value, icon: Icon, gradient, shadowColor }) => (
  <div className={`relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${shadowColor} bg-white border border-white/50 backdrop-blur-xl group`}>
